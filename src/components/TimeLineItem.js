...
function TimeLineItem({ university, degree, date, description }) {
  return (
    <li className=" mb-5  cursor-pointer">
      <div className="flex group items-center ">
        <div className="bg-custom-lightGray group-hover:bg-blue-900 z-10 rounded-full border-4 border-gray-800  h-5 w-5">
